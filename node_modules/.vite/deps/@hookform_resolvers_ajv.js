import {
  o,
  r
} from "./chunk-5M63EWPF.js";
import {
  appendErrors
} from "./chunk-VFJ5W5G4.js";
...
var require_core = __commonJS({
  "node_modules/ajv/dist/core.js"(exports) {
    ...
    function requiredOptions(o3) {
      ...
      return {
        strictSchema: (_f = (_e = o3.strictSchema) !== null && _e !== void 0 ? _e : s) !== null && _f !== void 0 ? _f : true,
        strictNumbers: (_h = (_g = o3.strictNumbers) !== null && _g !== void 0 ? _g : s) !== null && _h !== void 0 ? _h : true,
        strictTypes: (_k = (_j = o3.strictTypes) !== null && _j !== void 0 ? _j : s) !== null && _k !== void 0 ? _k : "log",
        strictTuples: (_m = (_l = o3.strictTuples) !== null && _l !== void 0 ? _l : s) !== null && _m !== void 0 ? _m : "log",
        strictRequired: (_p = (_o = o3.strictRequired) !== null && _o !== void 0 ? _o : s) !== null && _p !== void 0 ? _p : false,
...
var t = function(r2, e) {
  ...
  }), r2.reduce(function(r3, o3) {
    var a2 = o3.instancePath.substring(1).replace(/\//g, ".");
    if (r3[a2] || (r3[a2] = { message: o3.message, type: o3.keyword }), e) {
      var t2 = r3[a2].types, i2 = t2 && t2[o3.keyword];
      r3[a2] = appendErrors(a2, e, r3, o3.keyword, i2 ? [].concat(i2, o3.message || "") : o3.message);
    }
    return r3;
  }, {});
};
var i = function(s, i2, n) {
  return void 0 === n && (n = {}), function(c, m, u) {
    try {
      var l = new import_ajv.default(Object.assign({}, { allErrors: true, validateSchema: true }, i2));
      (0, import_ajv_errors.default)(l);
      var v = l.compile(Object.assign({ $async: n && "async" === n.mode }, s)), d = v(c);
      return u.shouldUseNativeValidation && o({}, u), Promise.resolve(d ? { values: c, errors: {} } : { values: {}, errors: r(t(v.errors, !u.shouldUseNativeValidation && "all" === u.criteriaMode), u) });
    } catch (r2) {
...
//# sourceMappingURL=@hookform_resolvers_ajv.js.map
